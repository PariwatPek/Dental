...
import fragment.HealRootFragment;

public class HealRootActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_heal_root);
        initInstances();
        if (savedInstanceState == null){
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.contentContainer, HealRootFragment.newInstance())
                    .commit();
        }
    }
