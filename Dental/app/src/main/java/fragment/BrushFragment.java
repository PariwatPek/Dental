...
public class BrushFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_brush_teeth, container, false);
    ...
    private void initInstances(final View rootView) {
        ...
        Button btnBrush = (Button) rootView.findViewById(R.id.btn);
        final TextView tvBrush = (TextView) rootView.findViewById(R.id.tv1);
