...
public class CoverFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_cover_teeth, container, false);
    ...
    private void initInstances(final View rootView) {
        ...
        Button btnCover = (Button) rootView.findViewById(R.id.btn);
        final TextView tvCover = (TextView) rootView.findViewById(R.id.tv1);
