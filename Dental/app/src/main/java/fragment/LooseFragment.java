...
public class LooseFragment extends Fragment {
    ...
    public static LooseFragment newInstance() {
        LooseFragment fragment = new LooseFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_loose_teeth, container, false);
    ...
    private void initInstances(final View rootView) {
        ...
        Button btnLoose = (Button) rootView.findViewById(R.id.btn);
        final TextView tvLoose = (TextView) rootView.findViewById(R.id.tv1);
