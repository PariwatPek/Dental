...
public class PullFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_pull_teeth, container, false);
    ...
    private void initInstances(final View rootView) {
        ...
        Button btnPull = (Button) rootView.findViewById(R.id.btn);
        final TextView tvPull = (TextView) rootView.findViewById(R.id.tv1);
