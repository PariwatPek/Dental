...
public class WisdomFragment extends Fragment {
    ...
    public static WisdomFragment newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_wisdom_teeth, container, false);
    ...
    private void initInstances(final View rootView) {
        ...
        Button btnWisdom = (Button) rootView.findViewById(R.id.btn);
        final TextView tvWisdom = (TextView) rootView.findViewById(R.id.tv1);
